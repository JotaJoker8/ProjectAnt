...
public class VisitWebAmazon {
	...
	public void visitAmazon() throws Exception{
		try {
			driver.get(url);
			TestLinkIntegration.updateResults("WebTest3", "Test pasado correctamente", TestLinkAPIResults.TEST_PASSED);
		} catch (Exception e) {
			TestLinkIntegration.updateResults("WebTest3", "El test ha fallado", TestLinkAPIResults.TEST_FAILED);
		}
	}
